...
export async function generateTattooIdea(prompt: string) {
  try {
    const response = await fetch('/api/generate-tattoo-idea', {
      method: 'POST',
      headers: {
    ...
    return 'Failed to generate tattoo idea. Please try again.';
  }
}
    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] p-8">
      ...
      <div className="flex flex-col items-center justify-center space-y-8 text-center mb-8">
        ...
        <p className="max-w-md text-muted-foreground text-lg sm:text-xl font-medium">
          Get inspired with quick tattoo ideas and creative concepts. 
          Explore different styles and find your perfect design.
        </p>
      </div>

      {/* Your Prompt Input Area - Centered */}
